...
% Names=["AA" "AB" "AC" "AD" "AE" "AF"];
% Names=["BA" "BB" "BC" "BD"];
% Names=["AAA" "AAB" "AAC" "AAD"];
% Names=["CA" "CB" "CC" "CD" "CE" "CF"];
% Names=["DA" "DB" "DC" "DD"];
% Names=["ABA" "ABB" "ABC" "ABD"];
% Names=["EA" "EB" "EC" "ED"];
% Names=["ACA" "ACB" "ACC" "ACD"];
 Names=["GA" "GB" "GC" "GD" "GE" "GF"];
% Names=["HA" "HB" "HC"];
% Names=["IA" "IB" "IC"];

% Names=["JA" "JB" "JC" "JD" "JE" "JF"];
% Names=["KA" "KB" "KC" "KD"];
% Names=["LA" "LB" "LC"];
% Names=["MA" "MB" "MC" "MD" "ME" "MF"];
% Names=["NA" "NB" "NC"];
% Names=["OA" "OB" "OC"];

% Names=["DA" "ABA" "HA" "IA" "KA" "LA" "NA" "OA"];
% Names=["DB" "ABB" "HB" "IB" "KB" "LB" "NB" "OB"];
% Names=["DC" "ABC" "HC" "IC" "KC" "LC" "NC" "OC"];
