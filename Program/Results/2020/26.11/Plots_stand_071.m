...
% Names=["BAG"];
% Names=["ABA" "ABB" "ABC" "ABD" "ABE" "ABF" "ABG" "ABH" "ABI"];
% Names=["AGA" "AGB" "AGC"];
% Names=["AAB" "AAC" "AAD"];
% Names=["AGA" "AGC"];
% Names=["BAA" "BAD" "BAG" "BBA" "BBD" "BBG" "BCA" "BCD" "BCG"];
% Names=["CAA" "CAC" "CAE" "CAG" "CAI" "CAK" "CAM" "CAO" "CAQ" "CAS" "CAU" "CAW" "CAY" "CBA" "CBC" "CBE"];
% Names=["AA" "AB" "AC" "AD"];
% Names=["BA" "BE" "BF" "BB" "BC" "BD"];
Names=["Oo"];
